...
<div class="dc-wrap">
  ...
  <div class="dc-footer">
    <nav class="dc-panel-nav">
      ...
      <button class="dc-panel-link" id="dc-timeline-link">Timeline</button>
    </nav>
...
function wire(): void {
  ...
  if (_scene.phase === 'resolved') {
    ...
    document.getElementById('dc-timeline-link')?.addEventListener('click', () => {
      router.push('career_timeline');
    });
  }
}
